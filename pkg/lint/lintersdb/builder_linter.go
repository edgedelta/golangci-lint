...
import (
	...
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/arangolint"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/asasalint"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/asciicheck"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/bidichk"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/bodyclose"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/canonicalheader"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/containedctx"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/contextcheck"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/copyloopvar"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/cyclop"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/decorder"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/depguard"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/dogsled"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/dupl"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/dupword"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/durationcheck"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/embeddedstructfieldcheck"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/err113"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/errcheck"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/errchkjson"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/errname"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/errorlint"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/exhaustive"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/exhaustruct"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/exptostd"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/fatcontext"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/forbidigo"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/forcetypeassert"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/funcorder"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/funlen"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/gci"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/ginkgolinter"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/gocheckcompilerdirectives"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/gochecknoglobals"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/gochecknoinits"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/gochecksumtype"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/gocognit"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/goconst"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/gocritic"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/gocyclo"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/godoclint"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/godot"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/godox"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/gofmt"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/gofumpt"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/goheader"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/goimports"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/golines"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/gomoddirectives"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/gomodguard"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/goprintffuncname"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/gosec"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/gosmopolitan"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/govet"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/grouper"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/iface"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/importas"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/inamedparam"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/ineffassign"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/interfacebloat"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/intrange"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/iotamixing"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/ireturn"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/lll"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/loggercheck"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/maintidx"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/makezero"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/mirror"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/misspell"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/mnd"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/modernize"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/musttag"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/nakedret"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/nestif"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/nilerr"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/nilnesserr"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/nilnil"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/nlreturn"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/noctx"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/noinlineerr"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/nolintlint"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/nonamedreturns"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/nosprintfhostport"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/paralleltest"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/perfsprint"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/prealloc"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/predeclared"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/promlinter"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/protogetter"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/reassign"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/recvcheck"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/revive"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/rowserrcheck"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/sloglint"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/spancheck"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/sqlclosecheck"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/staticcheck"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/swaggo"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/tagalign"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/tagliatelle"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/testableexamples"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/testifylint"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/testpackage"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/thelper"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/tparallel"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/unconvert"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/unparam"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/unqueryvet"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/unused"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/usestdlibvars"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/usetesting"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/varnamelen"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/wastedassign"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/whitespace"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/wrapcheck"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/wsl"
	"github.com/edgedelta/golangci-lint/v2/pkg/golinters/zerologlint"
